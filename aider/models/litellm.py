...
class LiteLLMModel(Model):
    def __init__(self, name):
        ...
        if not model_data:
            # HACK: for gemini 1.5 pro to work, LiteLLM appears to need the
            # "-latest" part included in the model name, but it's not included
            # in the list of supported models that way, so finesse it here
